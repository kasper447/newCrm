...
export const getTeamMembers = (data) => api.get(`/api/team/${data}/members`);
export const addUser = (data) => api.post("/admin/user", data);
export const updateUser = (id, data) => api.patch(`/admin/user/${id}`, data);
export const addTeam = (data) => api.post("/api/team", data);
export const updateTeam = (id, data) => api.post(`/api/team/${data}`, data);
...
export const getTeam = (data) => api.get(`/api/team/${data}`);
export const removeMember = (data) =>
  api.patch("/api/team/member/remove", data);
...
export const addLeader = (data) => api.patch("/api/team/leader/add", data);
...
//Leader
export const getMembers_Leader = () => api.get("/api/team/members");
export const getTeam_Leader = () => api.get("/api/team/");

// Employee
export const getEmployeeTeam = (data) => api.get(`/api/team/${data}`);
export const getEmployeeTeamMembers = (data) =>
  api.get(`/api/team/${data}/members`);
